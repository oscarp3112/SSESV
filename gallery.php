    ...
    <main role="main">
      ...
      <article>
        <header class="section background-dark">
          <div class="line">        
            <h1 class="text-white margin-top-bottom-40 text-size-60 text-line-height-1">Bienvenido a nuestra galería</h1>
            <p class="margin-bottom-0 text-size-16">Acá, podras encontrar imágenes sobre los servicios
            que nosotros bridamos.</p>
          </div>  
        </header>
